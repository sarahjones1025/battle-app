    ...
    show: function show() {
        ...
        if (this.count++ === 2) {
            ...
            (function () {
                ...
                _this2.$el.find('.combatant_one > .char_pic').attr('src', _this2.model1.get('thumbnail') + '/standard_fantastic' + '.' + _this2.model1.get('extension'));

                _this2.$el.find('.combatant_two > .char_pic').attr('src', _this2.model2.get('thumbnail') + '/standard_fantastic' + '.' + _this2.model2.get('extension'));
...
var TopPicksView = Backbone.View.extend({
    ...
    show: function show() {
        this.$el.find('.first-hero img').attr('src', this.model1.get('thumbnail') + '/landscape_xlarge' + '.' + this.model1.get('extension'));

        this.$el.find('.second-hero img').attr('src', this.model2.get('thumbnail') + '/landscape_xlarge' + '.' + this.model2.get('extension'));

        this.$el.find('.third-hero img').attr('src', this.model3.get('thumbnail') + '/landscape_xlarge' + '.' + this.model3.get('extension'));

        this.$el.find('.fourth-hero img').attr('src', this.model4.get('thumbnail') + '/landscape_xlarge' + '.' + this.model4.get('extension'));

        this.$el.find('.fifth-hero img').attr('src', this.model5.get('thumbnail') + '/landscape_xlarge' + '.' + this.model5.get('extension'));

        this.$el.find('.sixth-hero img').attr('src', this.model6.get('thumbnail') + '/landscape_xlarge' + '.' + this.model6.get('extension'));
...
module.exports = "\n<img src=<%= get('thumbnail') + '/landscape_small' + '.' + get('extension') %> alt=\"character\">\n<p><%= get('name') %></p>\n<button class='.to-the-battle'>Send To Battle</button>\n\n ";
